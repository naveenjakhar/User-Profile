                                ...
                                <div className="col-8  mt-3 ml-4">
                                    <div id="Head1" className="row mt-3">
                                        ...
                                        <div className="col-6 d-flex justify-content-end d-flex align-items-center">
                                            <p><img className="mr-2" id="AVT" src={card.profilepicture} width="30px" height="30px"></img><span id="Profile_txt">{card.name}</span></p>
                                        </div>
                                    </div>
                                    <div className="row mt-3">
                                        ...
                                        <div  className="row" >
                                                ...
                                                <div class="ml-2"><span id="username">Address :</span></div>
                                                    <p className="ml-4" ><span id="username">Name</span> <span id="Profile_txt">{card.company.name}</span></p>
                                                    <p className="ml-4 mt-n3"><span id="username">Catchphrace :</span> <span id="Profile_txt">{card.company.catchPhrase}</span></p>
                                                    <p className="ml-4 mt-n3" ><span id="username">bs :</span> <span id="Profile_txt">{card.company.bs}</span></p>
